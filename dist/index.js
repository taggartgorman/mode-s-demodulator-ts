...
exports.Demodulator = exports.UNIT_METERS = exports.UNIT_FEET = void 0;
// @ts-ignore
const mode_s_msglen_1 = __importDefault(require("mode-s-msglen"));
// @ts-ignore
const mode_s_decoder_1 = __importDefault(require("mode-s-decoder"));
const PREAMBLE_US = 8; // microseconds
const FULL_LEN = PREAMBLE_US + mode_s_msglen_1.default.LONG_MSG_BITS;
exports.UNIT_FEET = mode_s_decoder_1.default.UNIT_FEET;
exports.UNIT_METERS = mode_s_decoder_1.default.UNIT_METERS;
class Demodulator {
    constructor(options) {
        this.options = {
            aggressive: (options === null || options === void 0 ? void 0 : options.aggressive) !== false,
            checkCrc: (options === null || options === void 0 ? void 0 : options.checkCrc) || true,
            crcOnly: (options === null || options === void 0 ? void 0 : options.crcOnly) || false,
            mag: (options === null || options === void 0 ? void 0 : options.mag) || null
        };
        this.decoder = new mode_s_decoder_1.default(this.options);
    ...
    computeMagnitudeVector(data, mag, size, signedInt = false) {
    ...
    detectMessage(mag, maglen, onMsg) {
        const bits = new Uint8Array(mode_s_msglen_1.default.LONG_MSG_BITS);
        const msg = new Uint8Array(mode_s_msglen_1.default.LONG_MSG_BITS / 2);
        const aux = new Uint16Array(mode_s_msglen_1.default.LONG_MSG_BITS * 2);
        ...
        for (let j = 0; j < maglen - FULL_LEN * 2; j++) {
            ...
            errors = 0;
            for (i = 0; i < mode_s_msglen_1.default.LONG_MSG_BITS * 2; i += 2) {
                ...
                if (i > 0 && delta < 256) {
                    ...
                    bits[i / 2] = 2; // error
                    if (i < mode_s_msglen_1.default.SHORT_MSG_BITS * 2) {
                        errors++;
                    }
                }
                else if (low > high) {
            ...
            for (i = 0; i < mode_s_msglen_1.default.LONG_MSG_BITS; i += 8) {
                msg[i / 8] =
                    bits[i] << 7 |
                        bits[i + 1] << 6 |
                        bits[i + 2] << 5 |
            ...
            const msglen = (0, mode_s_msglen_1.default)(msgtype) / 8;
...
function applyPhaseCorrection(mag, offset) {
    ...
    for (let j = 16; j < (mode_s_msglen_1.default.LONG_MSG_BITS - 1) * 2; j += 2) {
